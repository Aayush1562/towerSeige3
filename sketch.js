...
var block1,polygon1,ground1,engine,world,slingShot,sling,ball,polygon;
var stand;


function preload(){
  polygon1 = loadImage("polygonImg.jpeg")
}
...
function setup() {
  ...
  createCanvas(1200,400);
    ...
    world = engine.world;
    Engine.run(engine);
    ground1 = new Ground(500,790,900,20);
...
function keyPressed(){
  if(keyCode === 32)
	{
		Matter.Body.setPosition(this.polygon,{x:150, y:160})
